-- =====================================================================
-- ByteHub Laptop & Desktop Store - Professional Seed Data
-- Run with: npm run seed
-- Scope: laptops, desktops, PC parts and laptop/desktop accessories only.
-- =====================================================================
...
'A dependable work laptop for accounting, programming, browsing, meetings and everyday office use. The ThinkPad E16 balances a large 16-inch display, comfortable typing, upgrade-friendly memory/storage and business-grade build quality.',
...
'Built for gaming, 3D learning, video editing and demanding college workloads. The TUF A15 gives customers a proper dedicated-GPU laptop instead of a basic notebook, with thermals designed for sustained performance.',
...
'A practical daily-use laptop for online classes, office documents, web apps, media and light multitasking. Recommended for customers who need value, portability and clean everyday performance.',
...
'A balanced pre-built desktop for customers who want strong CPU performance, fast storage and serviceable parts. Ideal for design studios, programming labs, creators and office power users.',
...
'A quiet, easy-to-maintain desktop configured for shops, schools, offices and home workstations. Built from standard parts so future service and upgrades stay simple.',
...
'A strong choice for customers building a gaming PC, editing setup or fast workstation. Pair it with a compatible LGA1700 motherboard, quality cooler and DDR5 or DDR4 board depending on configuration.',
...
'Recommended for customers who want a modern DDR5 platform with excellent everyday speed and future upgrade options. Works well for gaming PCs, student desktops and compact creator systems.',
...
'A smart GPU upgrade for gaming desktops and creator PCs. Suitable for 1080p high settings, video editing acceleration, multi-monitor setups and entry-level AI/CUDA learning.',
...
'A practical upgrade for compatible DDR5 laptops. Helps customers run more tabs, office apps, coding tools and study software without constant slowdown.',
...
'Recommended for customers who need faster boot, quicker app loading and more storage. Works in compatible laptops and desktop motherboards with an M.2 NVMe slot.',
...
'A reliable base for Ryzen 7000 and newer AM5 desktop builds. Good for office power systems, creator PCs and gaming desktops that need onboard Wi-Fi and modern storage support.',
...
'A dependable power supply for customers upgrading from generic PSUs or building a stable desktop. Suitable for many mid-range processor and graphics card combinations.',
...
'A sharp upgrade for desktop customers who want smoother motion, more workspace and better visuals than a basic office monitor. Works well with gaming PCs, laptops and dual-screen setups.',
...
'A comfortable input combo for billing counters, reception desks, home office setups and laptop users who want a full desk layout without cable clutter.',
...
'Recommended for homes and small offices using multiple laptops, desktops and phones. Helps improve wireless coverage and stability compared with older routers.',
...
FROM products p
JOIN (
  SELECT 'lenovo-thinkpad-e16-gen-2-business-laptop' slug, 'https://p1-ofp.static.pub/fes/cms/2024/03/22/6u1s0s8a8y57al3o2n4f9c1m4rb2wj306136.png' image_url UNION ALL
  SELECT 'asus-tuf-gaming-a15-rtx-laptop', 'https://dlcdnwebimgs.asus.com/gain/62F4671F-F005-45AA-8A0D-6BC0510C3151/w717/h525' UNION ALL
  SELECT 'acer-aspire-5-everyday-laptop', 'https://images.acer.com/is/image/acer/Aspire-5-A515-58M-Steel-Gray-01-1?$Product-Cards-XL$' UNION ALL
  SELECT 'bytehub-ryzen-7-creator-desktop', 'https://m.media-amazon.com/images/I/71k3gOik46L._AC_SL1500_.jpg' UNION ALL
  SELECT 'bytehub-intel-office-desktop', 'https://m.media-amazon.com/images/I/61F1Xr1K3JL._AC_SL1500_.jpg' UNION ALL
  SELECT 'intel-core-i5-14600k-desktop-processor', 'https://www.intel.com/content/dam/www/central-libraries/us/en/images/2023-09/newsroom-14th-gen-intel-core-i5-processor-boxed.png.rendition.intel.web.480.270.png' UNION ALL
  SELECT 'amd-ryzen-5-7600-desktop-processor', 'https://www.amd.com/content/dam/amd/en/images/products/processors/ryzen/2505503-amd-ryzen-5-7600.jpg' UNION ALL
  SELECT 'nvidia-geforce-rtx-4060-8gb-graphics-card', 'https://m.media-amazon.com/images/I/81c9J4rrlTL._AC_SL1500_.jpg' UNION ALL
  SELECT 'crucial-16gb-ddr5-laptop-ram', 'https://m.media-amazon.com/images/I/61XQ7eFQWvL._AC_SL1500_.jpg' UNION ALL
  SELECT 'samsung-990-evo-1tb-nvme-ssd', 'https://m.media-amazon.com/images/I/71vFKBpKakL._AC_SL1500_.jpg' UNION ALL
  SELECT 'msi-pro-b650m-a-wifi-motherboard', 'https://m.media-amazon.com/images/I/81XvZVqXWOL._AC_SL1500_.jpg' UNION ALL
  SELECT 'corsair-cx650-650w-bronze-power-supply', 'https://m.media-amazon.com/images/I/71e6YWy4cDL._AC_SL1500_.jpg' UNION ALL
  SELECT 'lg-ultragear-27-inch-144hz-gaming-monitor', 'https://m.media-amazon.com/images/I/81QpkIctqPL._AC_SL1500_.jpg' UNION ALL
  SELECT 'logitech-mk345-wireless-keyboard-mouse-combo', 'https://m.media-amazon.com/images/I/71DFy3FxMOL._AC_SL1500_.jpg' UNION ALL
  SELECT 'tp-link-archer-ax23-wifi-6-router', 'https://m.media-amazon.com/images/I/51ID0QlRD-L._AC_SL1000_.jpg'
